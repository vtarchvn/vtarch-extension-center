...
3. Cài `test-fixtures/vec_sample.rb`; kiểm tra file được theo dõi.
...
6. Cài `test-fixtures/VEC_RBZ_Fixture.rbz`; xác nhận mọi file xuất hiện, sau đó chuyển vào backup và khôi phục.
